                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <form action="" method="GET" class="parsley-form">
                                        <!-- Start fields -->
                                        <div class="form-group">
                                            <label>Policy No</label>
                                            <div>
                                                <input name="policyno" type="text" class="form-control" required="" data-parsley-maxlength="8" placeholder="Max 8 chars">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="effectivedate" type="text" class="form-control" required="" data-provide="datepicker" parsley-type="date" placeholder="dd/mm/yy" data-date-autoclose="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="expirydate" type="text" class="form-control" required="" data-provide="datepicker" parsley-type="date" placeholder="dd/mm/yy" data-date-autoclose="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Policy Owner</label>
                                            <div>
                                                <input name="policyowner" type="text" class="form-control" required="" data-parsley-maxlength="8" placeholder="Max 8 chars">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Engine No</label>
                                            <div>
                                                <input name="enghineno" type="text" class="form-control" required="" data-parsley-maxlength="30" placeholder="1325ACEW">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Chassis No</label>
                                            <div>
                                                <input name="chassicno" type="text" class="form-control" required="" data-parsley-maxlength="30" placeholder="C1411MF">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Vehicle Registration No</label>
                                            <div>
                                                <input name="vehicleregistrationno" type="text" class="form-control" required="" data-parsley-maxlength="30" placeholder="51H-791.02">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input data-parsley-type="number" name="suminsured" type="number" class="form-control" required="" min="0" data-parsley-maxlength="17" placeholder="10,000,000.00">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Rate</label>
                                            <div>
                                                <input step="0.01" data-parsley-type="number" name="rate" type="number" class="form-control" required="" min="0" data-parsley-maxlength="4" placeholder="0.1">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Annual Premium</label>
                                            <div>
                                                <input data-parsley-type="number" name="annualpremium" type="number" class="form-control" required="" min="0" data-parsley-maxlength="17">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Posted Premium</label>
                                            <div>
                                                <input data-parsley-type="number" name="postedpremium" type="number" class="form-control" required="" min="0" data-parsley-maxlength="17">
                                            </div>
                                        </div>
